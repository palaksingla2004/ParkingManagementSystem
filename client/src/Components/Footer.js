...
//           <h3 id="social-heading" className="sr-only" align="center">Follow us on social media</h3>
...
//           <h3 id="footer-links-heading" className="sr-only"align="center">Footer Links</h3>
...
//         </ul>
//         <p className="footer__copyright" align="center">
...
const Footer = () => {
  ...
  return (
    <div>
      <footer className="footer" role="contentinfo" itemScope itemType="http://schema.org/WPFooter">
        <div className="footer__social" role="navigation" aria-labelledby="social-heading">
        <h3 id="social-heading" align="center">Follow us on social media</h3> 
        ...
        <p className="footer__copyright" align="center">
          ©️ {currentYear} PalakSingla. All Rights Reserved,Parking Management System
        </p>
      </footer>
    </div>
  );
